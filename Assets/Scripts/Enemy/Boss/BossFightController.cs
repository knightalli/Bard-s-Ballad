...
// Скрипт BossFightController наследует логику от Enemy
public class BossFightController : Enemy
{
    ...
    private void Awake()
    {
        // Задаём начальное здоровье через базовый метод
        SetHealth(maxHealth);
    }
    ...
    {
        // Поддерживаем логику оглушения из Enemy
        base.Update();
    }
    ...
    private IEnumerator AttackRoutine()
    {
        ...
        {
            // Переход во вторую фазу при 50% HP
